...
string model = "D:/tensorflow/ssd_mobilenet_v2_coco_2018_03_29/frozen_inference_graph.pb";
string config = "D:/tensorflow/ssd_mobilenet_v2_coco_2018_03_29/graph.pbtxt";
void dnn_tf();
void dnn_ir_tf();
...
void dnn_ir_tf() {
	string xml = "D:/projects/models/frozen_inference_graph.xml";
	string bin = "D:/projects/models/frozen_inference_graph.bin";
	Mat src = imread("D:/images/dog.jpg");
	if (src.empty()) {
		printf("could not load image...\n");
		return;
