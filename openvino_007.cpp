...
int main(int argc, char** argv) {
	string xml = "D:/projects/models/road-segmentation-adas-0001/road-segmentation-adas-0001.xml";
	string bin = "D:/projects/models/road-segmentation-adas-0001/road-segmentation-adas-0001.bin";
	...
	VideoCapture capture("D:/images/video/project_video.mp4");
