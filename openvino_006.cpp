...
void matU8ToBlob(const cv::Mat& orig_image, InferenceEngine::Blob::Ptr& blob) {
	...
	for (size_t h = 0; h < height; h++) {
		const uchar* curr_row = resized_image.ptr<uchar>(h);
...
int main(int argc, char** argv) {
	...
	emotion_reader.ReadNetwork("D:/projects/models/emotions-recognition-retail-0003/emotions-recognition-retail-0003.xml");
	emotion_reader.ReadWeights("D:/projects/models/emotions-recognition-retail-0003/emotions-recognition-retail-0003.bin");
